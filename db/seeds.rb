...
authors = User.create!([
  ...
  {name: 'John Doe', bio: 'I am the default username everywhere, beware I don\'t hunt your dreams', email: 'john@doe.com', password: 'johndoe', password_confirmation: 'johndoe'}
])
